...
As my title suggests, I built "Gajure:":http://github.com/Ejhfast/Gajure a framework for constructing genetic algorithms in Clojure. As the definition of framework is debatable, excuse my pretension: I mean only that Gajure is something I can reuse. 
