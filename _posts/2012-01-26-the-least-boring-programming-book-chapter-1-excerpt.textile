...
p(meta). {{"(The Least Boring Programming Book teaches Ruby programming to beginners in an unconventional way. This is an early excerpt -- think alpha chapter)" | upcase }}
