...
I don't like writing test cases, and at "Hirewolf":http://hirewolf.com I don't write them -- my browser does. I cannot overstate the convenience of automation. To generate 800 test cases, I do this:

pre. AngelJS.testcases = 200
// I want to test add_all, my_prop_is_true, fullname, and join_char
AngelJS.test = 
  [{ func: add_all, 
...
I use *AngelJS.arr(type)* to generate parameter arrays of a given _type_ (whereas JavaScript array notation [] specifies tuples). These are of pseudo-random length, something which can be adjusted in the framework.
