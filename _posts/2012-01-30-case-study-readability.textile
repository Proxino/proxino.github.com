...
And now we're back to a paragraph. The list is distinctly set off, yet it remains unobtrusive. Numbered lists share one additional consideration: the position of the numbers (you can't elide numbers if you want a numbered list). They go outside the column to improve flow.
